...
- **Stellar xChain — in development.** Soroban-aware integration begins next sprint. Will support both Allbridge Core (live mainnet today, delivers Soroban-wrapped USDC) and Circle CCTP V2 (testnet today, mainnet pending Circle's 2026 ship). Both protocols share the same xChain attempts pipeline; Stellar adds a destination, not a parallel system.
