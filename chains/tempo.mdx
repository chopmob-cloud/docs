...
- [AlgoVoi Chrome extension](https://chromewebstore.google.com/detail/algovoi/ofmgegnkjdmbeakjbmfaagigmhagdcbl) (in-house wallet, native x402 / MPP / AP2 on Tempo via viem `signTransaction` + ERC-20 `transfer` for USDCe; six-chain coverage as of v2.5.0)
