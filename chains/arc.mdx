...
- [AlgoVoi Chrome extension](https://chromewebstore.google.com/detail/algovoi/ofmgegnkjdmbeakjbmfaagigmhagdcbl) (in-house wallet, native x402 / MPP / AP2 on ARC via viem `signTransaction` + native value transfer — Arc's native gas token is USDC; six-chain coverage as of v2.5.0)
