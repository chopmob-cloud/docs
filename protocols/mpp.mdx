...
### Official paymentauth.org methods

| Chain | Method | Spec | `methodDetails` |
| --- | --- | --- | --- |
| Tempo | `tempo` | [draft-tempo-charge-00](https://paymentauth.org/draft-tempo-charge-00) | none — flat request object |
| Solana | `solana` | [draft-solana-charge-00](https://paymentauth.org/draft-solana-charge-00) | `network: "mainnet"\|"devnet"`, `decimals` |
| Stellar | `stellar` | [draft-stellar-charge-00](https://paymentauth.org/draft-stellar-charge-00) | `network: "stellar:pubnet"\|"stellar:testnet"` |
| Base | `evm` | [draft-evm-charge-00](https://paymentauth.org/draft-evm-charge-00) | `chainId: 8453`, `credentialTypes: ["hash","permit2"]` |

### Custom methods (AlgoVoi extensions)
...
| Chain | Method | `methodDetails` |
| --- | --- | --- |
| Algorand | `algorand` | `network: "algorand:mainnet"\|"algorand:testnet"` |
| VOI | `voi` | `network: "voi:mainnet"\|"voi:testnet"` |
