...
- [pay.sh](https://pay.sh) (Solana Foundation) — canonical x402/MPP CLI client + MCP server for Solana with biometric local signing. The AlgoVoi catalog at `/.well-known/pay-skills.json` is pay.sh-compatible and registered as an aggregator at [solana-foundation/pay#349](https://github.com/solana-foundation/pay/pull/349). pay.sh users can pay AlgoVoi-protected resources end-to-end with no AlgoVoi-specific client.
