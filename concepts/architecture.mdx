...
- **Gateway cluster** is the canonical entry point for all payment protocol traffic. It owns x402, MPP, AP2, A2A skills, hosted checkout, the cloud event bridge, and the database. The public hostname is `api.algovoi.co.uk`.
