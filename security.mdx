...
For the full Information Security Policy and ICT Risk Management Framework (1,195 lines covering SOC 2 CC1–CC9, DORA Articles 5–11, full risk register, incident runbooks, and BCP playbooks), [request the NDA-tier document](mailto:security@algovoi.co.uk?subject=Information+Security+Policy+request).
...
<AccordionGroup>
  <Accordion title="Are you SOC 2 audited?">
    Not yet. SOC 2 Type II audit is scheduled subject to the first-paying-tenants
    milestone. The Information Security Policy is mapped to SOC 2 CC1–CC9 today,
    so a Type II audit is a fieldwork exercise rather than a controls-design
    exercise. Available on signed NDA for prospects who want to assess the
    controls in advance.
  </Accordion>
...
- Information Security Policy (1,195 lines, full risk register + incident runbooks + BCP playbooks) — available on signed NDA
...
| Date | Change |
|---|---|
| 2026-05-03 | Initial publication. Hash-chained audit log and Object Lock shipping marked live. VM1 firewall enforcement marked live. Information Security Policy v1.0 referenced. |
