...
| --- | --- | --- |
| **Python** `algovoi-mcp` | [pypi.org/project/algovoi-mcp/1.4.3](https://pypi.org/project/algovoi-mcp/1.4.3/) | `uvx algovoi-mcp==1.4.3` |
| **TypeScript** `@algovoi/mcp-server` | [npmjs.com/package/@algovoi/mcp-server](https://www.npmjs.com/package/@algovoi/mcp-server) | `npx -y @algovoi/mcp-server@1.4.3` |

Both expose the same 25 tools across all 8 chains (Base, Algorand, Solana, Stellar, Hedera, Tempo, VOI, and ARC testnet). Functional behaviour is identical.
